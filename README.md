...
Verified inventory (2026-07-30): **24 skills, 24 slash commands, 14
specialist agents, 453 passing tests.**
...
- [zilliztech/memsearch](https://github.com/zilliztech/memsearch) - persistent memory for coding agents. It arrived at the same core choice this project made independently: markdown is the source of truth, human-readable and version-controlled, with any index treated as a rebuildable cache. Its progressive L1/L2/L3 retrieval is a tracked revisit trigger in `ROADMAP.md` for the day a brain outgrows plain-text search; its vector database, embedding model, and file watchers stay unadopted here by design.
